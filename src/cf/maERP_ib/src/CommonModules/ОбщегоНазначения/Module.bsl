...
Функция СформироватьПараметрыПредметаИсчисленияДляКоличества(Количество) Экспорт
	Результат = "";
	Если Количество = Цел(Количество) Тогда
		Результат = ",,,,,,,,0";
	ИначеЕсли Количество = Окр(Количество, 1) Тогда
		Результат = "целая, целых, целых, ж, десятая, десятых, десятых, ж, 1";
	ИначеЕсли Количество = Окр(Количество, 2) Тогда
		Результат = "целая, целых, целых, ж, сотая, сотых, сотых, ж, 2";
	ИначеЕсли Количество = Окр(Количество, 3) Тогда
		Результат = "целая, целых, целых, ж, тысячная, тысячных, тысячных, ж, 3";	
	КонецЕсли;	
	Возврат Результат;
КонецФункции
...
Функция ЗначенияРеквизитовОбъекта(Ссылка, Знач Реквизиты) Экспорт
	...
	ИначеЕсли ТипЗнч(Реквизиты) = Тип("Массив") Или ТипЗнч(Реквизиты) = Тип("ФиксированныйМассив") Тогда
		...
		КонецЦикла;
	Иначе
		ВызватьИсключение "Неверный тип второго параметра Реквизиты: " + Строка(ТипЗнч(Реквизиты));
	КонецЕсли;
