...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаголовокАвторегистрации = НСтр("fr = 'Enregistrement automatique pour le nœud ""%1""'; ru = 'Авторегистрация для узла ""%1""'; en = 'Auto-registration for the %1 node'; es = 'Registro automático para el nodo ""%1""'");
