...
Функция ОбщийМодуль(Имя) Экспорт
	...
	Если ТипЗнч(Модуль) <> Тип("ОбщийМодуль") Тогда
		ВызватьИсключение СтрЗаменить(НСтр("ru = 'Общий модуль ""%1"" не найден.'; fr = 'Module commun ""%1"" n''a pas été trouvé.'; en = 'The common module ""%1"" was not found.'; es = 'No se encontró el módulo genérico ""%1"".'"), "%1", Имя);
	КонецЕсли;
