...
// наименование, артикул, характеристика, серия.
//
// Параметры:
...
//
Функция ПредставлениеНоменклатуры(Номенклатура, Характеристика, Серия = Неопределено, ЭтоПечать = Ложь) Экспорт
...
Процедура УдалитьЗначениеИзМассива(Мас, Значение) Экспорт
	Индекс = Мас.Найти(Значение);
