...
Процедура ОбновитьСписокВыбранныхНаСервере()
	...
	Если КоличествоВыбранных > 1000 Тогда
		КоличествоВыбранных = НСтр("fr = '> 1000'; ru = '> 1000'; en = '\u003e 1000'; es = '\u003e 1000'");
	...
	КонецЕсли;
	Элементы.ГруппаВыбранныеОбъекты.Заголовок = ПодставитьПараметрыВСтроку(НСтр("fr = 'Éléments sélectionnés (%1)'; ru = 'Выбранные элементы (%1)'; en = 'Selected items (%1)'; es = 'Elementos seleccionados (%1)'"), КоличествоВыбранных);
