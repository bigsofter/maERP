...
Процедура ИзменитьРегистрацию(Команда)
	...
	Текст = НСтр("fr = ""Modifier l'inscription '%1'"
"sur les nœuds?""; ru = 'Изменить регистрацию ""%1"""
"на узлах?'; en = 'Change the registration of ""%1"""
"on the nodes?'; es = 'Cambiar el registro ""%1"""
"¿en nudos?'");
