# Сводный индекс спецификаций платформенного XML-формата 1С

Единая точка входа ко всем спецификациям платформенного XML-формата выгрузки
1С:Предприятие 8.3. Это не EDT/MDO-формат. Перед применением этих
спецификаций к проекту сначала выбери source-set через `unica.view {}` и
проверь, что его `sourceFormat` равен `platform_xml`.
